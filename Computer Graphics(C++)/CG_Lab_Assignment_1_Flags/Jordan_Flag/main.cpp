...
void drawFlag()
{
    ...
    drawRectangle(0, 400, 900, 600);
    setColor(1.0f, 1.0f, 1.0f);
    drawRectangle(0, 200, 900, 400);
    setColor(0.0f, 0.45f, 0.0f);
    drawRectangle(0, 0, 900, 200);

    setColor(0.8f, 0.0f, 0.0f);
    drawTriangle(0, 0, 0, 600, 420, 300);

    setColor(1.0f, 1.0f, 1.0f);
    drawFilledStar(7, 135, 300, 42, 18, 90);
}
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Jordan Flag - CG Lab Assignment 1");
    init();
