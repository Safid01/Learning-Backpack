...
void drawFlag()
{
    ...
    {
        setColor(1.0f, 1.0f, 1.0f);
        drawFilledStar(5, stars[i][0], stars[i][1], stars[i][2], stars[i][2] * 0.42f, 90);
        setColor(0.8f, 0.0f, 0.0f);
        drawFilledStar(5, stars[i][0], stars[i][1], stars[i][2] * 0.72f, stars[i][2] * 0.30f, 90);
    }
}
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("New Zealand Flag - CG Lab Assignment 1");
    init();
